...
RSpec.describe 'Books', type: :request do
  ...
  let(:user) { FactoryBot.create(:user, username: 'djt', password: 'password') }
  ...
  describe 'POST /books/:id' do
    ...
    context 'when request attributes are valid' do
      before { post '/api/v1/books', params: valid_attributes, headers: { 'Authorization' => AuthenticationTokenService.call(user1.id) } }
    ...
    context 'when an invalid request' do
      before { post '/api/v1/books', params: {}, headers: { 'Authorization' => AuthenticationTokenService.call(user1.id) } }
